/*
 * ============================================================
 *  BUBBLE SORT - Analisis Algoritma Sorting
...
// Bubble Sort dengan timeout check
...
double bubbleSort(vector<int>& arr) {
    ...
    for (int i = 0; i < n - 1; i++) {
        ...
        // Cek timeout setiap iterasi luar
...
int main() {
    ...
    cout << "============================================================" << endl;
    cout << "           BUBBLE SORT - ANALISIS PERFORMA" << endl;
    ...
    ofstream logFile("bubble_sort_results.txt");
    ...
    for (int n : sizes) {
        ...
        // Skip otomatis jika data terlalu besar (Bubble Sort O(n^2))
        if (n > 100000) {
            cout << setw(20) << "N/A"
                 << setw(20) << "N/A"
    ...
    cout << "  Best Case    : O(n)      - data sudah terurut" << endl;
    cout << "  Average Case : O(n^2)    - data acak" << endl;
    cout << "  Worst Case   : O(n^2)    - data terurut terbalik" << endl;
    cout << "Kompleksitas Ruang: O(1)   - in-place sorting" << endl;
    cout << "============================================================" << endl;
    cout << "Hasil disimpan di: bubble_sort_results.txt" << endl;
